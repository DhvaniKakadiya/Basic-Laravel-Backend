...
<div class="row">
    <div class="col-lg-12">
		...
		<div class="row">
			<div class="col-lg-8">		
				<form action="./{{$ep_id}}" method="POST">
					{{csrf_field()}}
					<div class="form-group">
						<label>Series Name</label>
						<select class="form-control" id="dialogues" name="episode" required>
								@foreach ( $episode as $c )
								@if($c->series_id==$ep_id)
								<option name="{{$c->series_id}}" selected value="{{$c->series_id}}">
					...
					<div class="form-group">
					    ...
					    <div class="input_fields_wrap-tr">
						    ...
						    @foreach($travia as $tr)
						    	<div><br><label>Add Travia : </label>
						    	<textarea class="form-control" name="travia[]" value="{{$tr->travia_details}}">
								{{$tr->travia_details}}
						    	</textarea>
						    	<input type="checkbox" name="travia-chk-box[<?php echo $t_count++ ;?>]" value="true" <?php if($tr->isspoiler){echo "checked";}?>>Contain Spoiler<br>
					...
					<div class="form-group">
						...
						<div class="input_fields_wrap-qu">
						    ...
						    @foreach($quotes as $qu)
						    	<div><br><label>Add Quotes : </label>
						    	<textarea class="form-control" name="quotes[]" value="{{$qu->quotes_details}}">
								{{$qu->quotes_details}}
						    	</textarea>
						    	<input type="checkbox" name="quotes-chk-box[<?php echo $q_count++ ;?>]" value="true" <?php if($qu->isspoiler){echo "checked";}?>>Contain Spoiler<br>
						    	<a href="#" class="remove_field">Remove</a></div>
						    @endforeach					
					    </div>
					</div>
					<div class="form-group">
						...
						<div class="input_fields_wrap-cc">
						    ...
						    <?php $cc_count = 0 ;?>
						    @foreach($crazy as $cc)
						    	<div><br><label>Add CrazyCredits : </label>
						    	<textarea class="form-control" name="crazy_credits[]" value="{{$cc->crazy_credits_details}}">
								{{$cc->crazy_credits_details}}
						    	</textarea>
						    	<input type="checkbox" name="crazy_credits-chk-box[<?php echo $cc_count++ ;?>]" value="true" <?php if($cc->isspoiler){echo "checked";}?>>Contain Spoiler<br>
						    	<a href="#" class="remove_field">Remove</a></div>
						    @endforeach					
					    </div>
					</div>
					<div class="form-group">
						...
						<div class="input_fields_wrap-go">
						    ...
						    <?php $g_count = 0 ;?>
						    @foreach($goofs as $g)
						    	<div><br><label>Add Goofs : </label>
						    	<textarea class="form-control" name="goofs[]" value="{{$g->goofs_details}}">
								{{$g->goofs_details}}
						    	</textarea>
						    	<input type="checkbox" name="goofs-chk-box[<?php echo $g_count++ ;?>]" value="true" <?php if($qu->isspoiler){echo "checked";}?>>Contain Spoiler<br>
						    	<a href="#" class="remove_field">Remove</a></div>
						    @endforeach						
					    </div>
					</div>
